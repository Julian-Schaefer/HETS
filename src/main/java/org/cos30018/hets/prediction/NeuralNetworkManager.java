...
import static org.cos30018.hets.logic.appliance.Appliance.ApplianceType.*;
...
public class NeuralNetworkManager {
    ...
    private void readLocalData(String applianceReferenceCode){
        ...
        try {
            ...
            //read the first 30,000 data values from the csv file, given the specified appliance.
            //Ignores null values
