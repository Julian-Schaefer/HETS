...
public class HomePanel extends JPanel {
	...
	public JPanel HomeContentPanel() {
		...
		JPanel toolbarPanel = new JPanel(new MigLayout("insets 20 20 20 20"));
		...
		toolbarPanel.add(titleHome);
		toolbarPanel.add(btnConfigFile);
		...
		homeContentLayout.add(toolbarPanel, BorderLayout.NORTH);
